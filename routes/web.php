...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('dashboard/{peg}/edit', [PegawaiController::class, 'edit'])->name('edit');
    Route::post('dashboard/add', [PegawaiController::class, 'add'])->name('add');
    Route::patch('dashboard/{peg}', [PegawaiController::class, 'update'])->name('update');
    Route::delete('dashboard/{peg}', [PegawaiController::class, 'destroy'])->name('hapus');
    Route::post('search', [PegawaiController::class, 'search'])->name('search');
    Route::get('/jenis', [JenisController::class, 'index'])->name('jenis');
    Route::post('/create_jenis', [JenisController::class, 'create'])->name('create_jenis');
    Route::patch('jenis/{jenis}', [JenisController::class, 'edit'])->name('update_jenis');
    Route::delete('jenis/{jenis}', [JenisController::class, 'destroy'])->name('delete_jenis');
    Route::get('/bykode', [CetakController::class, 'bykode'])->name('bykode');
    Route::post('/searchkode', [CetakController::class, 'searchkode'])->name('searchkode');
    Route::post('/printkodecetak', [CetakController::class, 'printkodecetak'])->name('printkodecetak');
    Route::get('/bynip', [CetakController::class, 'bynip'])->name('bynip');
    Route::post('/searchnip', [CetakController::class, 'searchnip'])->name('searchnip');
    Route::post('/printnip', [CetakController::class, 'printnip'])->name('printnip');
    Route::get('/tandaterima', [TandaTerimaController::class, 'tandaterima'])->name('tandaterima');
    Route::post('/printtandaterima', [TandaTerimaController::class, 'printtandaterima'])->name('printtandaterima');
});
