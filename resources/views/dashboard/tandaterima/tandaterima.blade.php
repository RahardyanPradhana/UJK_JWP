        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Cetak Tanda Terima</h5>
                </div>
                <div class="card-body">
                    <!-- <h6 class="card-subtitle">With DataTables you can alter the ordering characteristics of the table at initialisation time.</h6> -->
                    <form action="{{route('printtandaterima')}}" method="post">
                        @csrf
                        <div class="container form-group">
                            <div class="row">
                                <input type="text" class=" col-md-4" name="kdcetak" placeholder="Cari Berdasarkan Kode Cetak">
