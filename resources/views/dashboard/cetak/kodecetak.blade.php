            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <div class="container row">
                        <form action="{{route('searchkode')}}" class="col-md-4" method="post">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <input type="text" class=" col-md-10" name="kdcetak" placeholder="Masukkan Kode Cetak">
                                    <button type='submit' class='btn btn-primary col-md-2'><i class='fa fa-search'></i></button>
                                </div>
                            </div>
                        </form>
                        <form action="{{route('printkodecetak')}}" class="col-md-2 offset-md-6" method="post">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <input type="hidden" name="kdcetak" value="{{$req}}">
