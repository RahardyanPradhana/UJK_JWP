        ...
        <div class="col-md-8 col-lg-8">
            ...
            <div class="breadcrumb-list">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">NIP</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="card-title">Cetak Berdasarkan Kode Cetak</h5>
                </div>
                <div class="card-body">
                    <!-- <h6 class="card-subtitle">With DataTables you can alter the ordering characteristics of the table at initialisation time.</h6> -->
                    <form action="{{route('searchnip')}}" method="post">
                        @csrf
                        <div class="container form-group">
                            <div class="row">
                                <input type="text" class=" col-md-4" name="nip" placeholder="NIP">
