                            ...
                            <div class="card bg-dark bg-gradient">
                                <div class="card-body">
                                    <form action="" method="post">
                                        {{ csrf_field() }}
                                        <div class="form-head">
                                            <a href="{{url('/')}}" class="logo"><img src="assets/img/logo.png" class="img-fluid" alt="logo"></a>
                                            <h4 class="text-info my-4">Aplikasi Cetak Kartu Identitas</h4>
                                            {{-- <h4 class="text-info my-4">Aplikasi Cetak Kartu Identitas</h4> --}}
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-outline-info btn-lg btn-block font-18">Log in</button>
                                    </form>
                                </div>
                            </div>
                        </div>
